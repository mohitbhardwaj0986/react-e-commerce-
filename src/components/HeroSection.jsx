...
function HeroSection() {
  return (
    <div className="w-full h-[80vh] bg-blue-500 flex items-center ">
      ...
      <div class=" justify-end gap-6 hidden sm:block">
        <img
          class="rounded-md w-[30vh] absolute top-36 left-[70vw]"
          src={img1}
          alt=""
        />
        <img
          class="rounded-md w-[30vh] absolute top-80 left-[80vw]"
          src={img2}
          alt=""
        />
        <img class="rounded-md w-[40vh] ml-11" src={img3} alt="" />
      </div>
    </div>
  );
}
